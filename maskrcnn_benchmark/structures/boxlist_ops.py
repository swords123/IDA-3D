...
def boxlist_nms_stereo(boxlist_left, boxlist_right, nms_thresh, max_proposals=-1, score_field="scores"):
    if nms_thresh <= 0:
    ...
    score = (boxlist_left.get_field(score_field) + boxlist_right.get_field(score_field)) * 0.5
...
def boxlist_nms_stereo_td(boxlist_left, boxlist_right, nms_thresh, max_proposals=-1, score_field="scores"):
    if nms_thresh <= 0:
        return boxlist_left, boxlist_right
    mode = boxlist_left.mode
    boxlist_left = boxlist_left.convert("xyxy")
