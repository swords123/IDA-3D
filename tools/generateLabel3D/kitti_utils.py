...
class KittiObject:
    def __init__(self):
        ...
        self.center_in_2d_left = []
        self.center_in_2d_right = []
        self.eight_points_in_left = []
        self.eight_points_in_right = []
        self.eight_points_in_3d = []
...
def read_obj_data(LABEL_PATH, calib=None, im_shape=None):
    ...
    '''
    used_cls = ['Car', 'Pedestrian','Cyclist']
    objects = []
    ...
    for object_index in range(len(detections)):
        ...
        object_it.orientation = object_it.orientation - m.pi/2  
        ...
        object_it.pos = object_it.pos + object_it.R.dot([0, -object_it.dim[1], 0])/2.0
        ...
        object_it.eight_points_in_3d = pts3_c_o
        for j in range(2): # left and right boxes
            ...
            if j == 0:
                object_it.center_in_2d_left = Space2Image(calib.p2_2, NormalizeVector(object_it.pos))
            elif j == 1:
                object_it.center_in_2d_right = Space2Image(calib.p2_3, NormalizeVector(object_it.pos))
